package ru.practicum.request.user.service;
...
import ru.practicum.request.user.mapper.UserMapper;
import ru.practicum.request.user.model.User;
import ru.practicum.request.user.param.UserParams;
import ru.practicum.request.user.repository.UserRepository;
